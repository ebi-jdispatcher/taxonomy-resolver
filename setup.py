...
from taxonresolver import __author__, __email__, __version__


def gather_dependencies():
    with open("requirements.txt", "r") as f_in:
        return [
            l for l in f_in.read().rsplit(os.linesep) if l and not l.startswith("#")
        ]
...
setup(
    ...
    license="LICENSE",
    entry_points={"console_scripts": ["taxonomy_resolver=taxonresolver.cli:cli"]},
    ...
    description=(
        "Taxonomy Resolver builds NCBI Taxonomy Trees and lists of "
